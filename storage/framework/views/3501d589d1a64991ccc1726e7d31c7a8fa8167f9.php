...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua-gradient">
            ...
            <a href="<?php echo e(route('OL',[DashboardCurrentUser::$RoleId, DashboardCurrentUser::$id, '4'])); ?>" class="small-box-footer">اطلاعات بیشتر <i
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green-gradient">
            ...
            <a href="<?php echo e(route('OL',[DashboardCurrentUser::$RoleId, DashboardCurrentUser::$id, '8'])); ?>" class="small-box-footer">اطلاعات بیشتر <i
                    class="fa fa-arrow-circle-left"></i></a>
        </div>
    </div>
    <!-- ./col -->
