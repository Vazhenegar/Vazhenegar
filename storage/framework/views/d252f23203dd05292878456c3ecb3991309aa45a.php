...
<?php
    ...
    DashboardCurrentUser::$OrderFinalCheck=OrdersList(DashboardCurrentUser::$RoleId, DashboardCurrentUser::$id, '7');
    DashboardCurrentUser::$AllOrders=OrdersList(DashboardCurrentUser::$RoleId, '', '');
