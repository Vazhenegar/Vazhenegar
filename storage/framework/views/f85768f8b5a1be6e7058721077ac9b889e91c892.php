                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-right">
                                        <a href="<?php echo e(route('changestatus', ['UserId'=>$CurrentUser->id, 'Status'=>'A'])); ?>" class="btn btn-default btn-flat">پروفایل</a>
                                    </div>
                                    <div class="pull-left">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i>نمودار ChartJS</a>
                            </li>
                            ...
                            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i>نمودار Inline
                                    charts</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i> قفل صفحه</a>
                            </li>
