                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="welcome-text">
                                <h2 data-animation="fadeInUp" data-delay="100ms"><span>ترجمه تخصصی </span><br> به چندین
                                    زبان در
            ...
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="welcome-text">
                                <h3 data-animation="fadeInUp" data-delay="100ms"><span>مترجمین متخصص </span><br> در
                                    زمینه های تخصصی
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6">
                <div class="about-us-thumbnail mb-80">
                    <img src="<?php echo e(asset('images/site/index about us.jpg')); ?>" alt="">
                </div>
            </div>
...
<section class="uza-blog-area">
                ...
                <div class="col-12 col-lg-8">
                    <div class="cta-content mb-80">
                        ...
                        <h6>
                            ...
                            فرم مربوطه را در بخش <a href="/employment">همکاری با ما</a> تکمیل نموده یا
    ...
    <div class="blog-bg-curve">
        <img src="<?php echo e(asset('images/core-img/curve-3.png')); ?>" alt="">
    </div>
</section>
<!-- CTA Area End -->
...
<?php echo $__env->make('vazhenegar.layout.MasterLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\vazhenegar\Main Project\resources\views\vazhenegar\index.blade.php ENDPATH**/ ?>