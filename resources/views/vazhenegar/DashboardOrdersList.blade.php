...
{{--this page will get user type and order list session and show table--}}
{{--all users type will use this file for viewing orders--}}

@switch(session('OrderList'))
    @case('AllOrders')
    {{--    this will show new, finished, cancelled and all type of orders depending on user type--}}
    ...
    @elseif(DashboardCurrentUser::$Role=='مشتری')
    @endif
    @break
@endswitch
