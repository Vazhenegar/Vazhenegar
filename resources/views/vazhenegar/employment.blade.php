...
@section('PageTitle', 'همکاری با ما')
    ...
    <div class="breadcrumb-area">
        <div class="container h-100">
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <h1 class="title">همکاری با ما</h1>
                </div>
            </div>
        </div>
        ...
        <div class="container" dir="rtl">
            ...
            <div class="col-12 col-lg-12">
                <div class="employment-form mb-40">
                    <form action="/employment" method="post" enctype="multipart/form-data">
                        <div class="row">
                            {{ csrf_field() }}
                            {{-- =========================================================================== --}}
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('FirstName'))
                                        <input type="text" class="wrong-field form-control mb-30" name="FirstName" value="{{old('FirstName')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="FirstName" value="{{old('FirstName')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('LastName'))
                                        <input type="text" class="wrong-field form-control mb-30" name="LastName" value="{{old('LastName')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="LastName" value="{{old('LastName')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('BirthDate'))
                                        <input type="text" class="wrong-field form-control mb-30 date_picker" name="BirthDate" value="{{old('BirthDate')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30 date_picker" name="BirthDate" value="{{old('BirthDate')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('Email'))
                                        <input type="text" class="wrong-field form-control mb-30" name="Email" id="email" value="{{old('Email')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="Email" id="email" value="{{old('Email')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('Password'))
                                        <input type="password" class="wrong-field form-control mb-30" name="Password" value="{{old('Password')}}" required>
                                    @else
                                        <input type="password" class="form-control mb-30" name="Password" value="{{old('Password')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('Password'))
                                        <input type="password" class=" wrong-field form-control mb-30" name="Password_confirmation" value="{{old('Password_confirmation')}}" required>
                                    @else
                                        <input type="password" class="form-control mb-30" name="Password_confirmation" value="{{old('Password_confirmation')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('FixNumber'))
                                        <input type="number" class="wrong-field form-control mb-30" name="FixNumber" value="{{old('FixNumber')}}" required>
                                    @else
                                        <input type="number" class="form-control mb-30" name="FixNumber" value="{{old('FixNumber')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('MobileNumber'))
                                        <input type="number" class="wrong-field form-control mb-30" name="MobileNumber" value="{{old('MobileNumber')}}" required>
                                    @else
                                        <input type="number" class="form-control mb-30" name="MobileNumber" value="{{old('MobileNumber')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('Address'))
                                        <input type="text" class="wrong-field form-control mb-30" name="Address" value="{{old('Address')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="Address" value="{{old('Address')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('Degree'))
                                        <input type="text" class="wrong-field form-control mb-30" name="Degree" value="{{old('Degree')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="Degree" value="{{old('Degree')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('GraduationDate'))
                                        <input type="text" class="wrong-field form-control mb-30 date_picker" name="GraduationDate" value="{{old('GraduationDate')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30 date_picker" name="GraduationDate" value="{{old('GraduationDate')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    @if ($errors->has('GraduationField'))
                                        <input type="text" class="wrong-field form-control mb-30" name="GraduationField" value="{{old('GraduationField')}}" required>
                                    @else
                                        <input type="text" class="form-control mb-30" name="GraduationField" value="{{old('GraduationField')}}" required>
                                    @endif
                            ...
                            <div class="col-12">
                                <div class="col-4 form-group">
                                    <textarea class="form-control mb-30" name="Resume" rows="8" cols="80">{{old('Resume')}}</textarea>
                                </div>
                            </div>
                            {{-- =========================================================================== --}}
                            <div class="col-12">
